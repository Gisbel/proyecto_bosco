                ...
                {averageTaskTime > 120 && (
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Tu tiempo promedio por tarea es de {formatTime(averageTaskTime)}. Considera dividir tareas grandes
                ...
                {totalPomodoros < 10 && dateRange === "week" && (
                  <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    <p className="text-sm text-purple-700">
                      Solo has completado {totalPomodoros} pomodoros esta semana. La técnica Pomodoro puede ayudarte a
                      mantener el enfoque.
                    </p>
                  </div>
                )}
